...
<tbody>
  ...
  return <List key={key} namex={data.pack.name}
               key={key} statusx={data.pack.status} 
               key={key} startDatex={data.pack.startDate} 
               key={key} typex={data.type}
               key={key} usagex={data.usage}
               key={key} usageDatex={data.usageDate}
               key={key} thresholdx={data.threshold}
               key={key} statusx={data.status}
         />
})}
