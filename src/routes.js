...
const routes = [
  ...
  { path: '/offer', name: 'Offering Package', component: Offer },
  { path: '/transaction', name: 'Loan Transaction', component: Transaction },
  { path: '/assignment', name: 'Assignment Rule', component: Assignment },
